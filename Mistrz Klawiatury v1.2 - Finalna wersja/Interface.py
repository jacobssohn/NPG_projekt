        ...
        if self.first_launch:
            ...
            if mode == "chs_plr":
                ...
                if self.language == "polish":
                    ...
                    messageToScreen(self.win, "Congratulations! Your score is {}.".format(self.score), 520, 150,
                                    fontSize=25)
    ...
    def start(self):  # funkcja odpowiedzialna za odpalenie i wyłączenie gry
        ...
        while run:
            ...
            for event in pg.event.get():
                ...
                keys_names = ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i',
                              'o','p', 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'z', 'x', 'c', 'v', 'b', 'n', 'm',
                              'backspace', 'return']

                if (event.type == pg.KEYDOWN and pg.key.name(
                        event.key) not in keys_names  # wyjątki które nie powodują wpisania nazwy klawisza
                        and (
                ...
                elif (keys[pg.K_LSHIFT] or keys[pg.K_RSHIFT]) and event.type == pg.KEYDOWN:
                    if keys[pg.K_1]:
                        letter = "!"
                    elif keys[pg.K_2]:
                        letter = "@"
